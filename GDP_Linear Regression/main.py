...
oecd_bli = pd.read_csv('data.txt', thousands=',')
gdp_per_capita = pd.read_csv('data2.txt', thousands=',', delimiter='\t',encoding='latin1',na_values='n/a')
...
model.fit(X, y)
X_new = [[22587]]
print(model.predict(X_new)) #should be 5.96242338